...
enum BST_DEV_ACC_OP_MODE { SENSOR_PM_NORMAL = 0, SENSOR_PM_SUSPEND = 3 };
...
#define SENSOR_TYPE_BOSCH_ACTIVITY_RECOGNITION \
  (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 31)
#define SENSOR_STRING_TYPE_BOSCH_AR \
  "com.bosch-BoschSensor.www.activityrecognition"

#define BSX_SENSOR_ID_AMBIENT_ALCOHOL 100
#define SENSOR_TYPE_BOSCH_AMBIENT_ALCOHOL \
  (SENSOR_TYPE_BOSCH_ACTIVITY_RECOGNITION + 1)
#define SENSOR_STRING_TYPE_BOSCH_AMBIENT_ALCOHOL \
  "com.bosch-BoschSensor.www.ALCOHOL"
#define BSX_SENSOR_ID_AMBIENT_CO2 101
#define SENSOR_TYPE_BOSCH_AMBIENT_CO2 \
  (SENSOR_TYPE_BOSCH_ACTIVITY_RECOGNITION + 2)
#define SENSOR_STRING_TYPE_BOSCH_AMBIENT_CO2 "com.bosch-BoschSensor.www.CO2"
#define BSX_SENSOR_ID_AMBIENT_IAQ 102
#define SENSOR_TYPE_BOSCH_AMBIENT_IAQ \
  (SENSOR_TYPE_BOSCH_ACTIVITY_RECOGNITION + 3)
#define SENSOR_STRING_TYPE_BOSCH_AMBIENT_IAQ "com.bosch-BoschSensor.www.IAQ"
#define BSX_SENSOR_ID_GAS_RESIST 103
#define SENSOR_TYPE_BOSCH_GAS_RESIST \
  (SENSOR_TYPE_BOSCH_ACTIVITY_RECOGNITION + 4)
...
extern BSX_SENSOR_CONFIG
    BSX_sensor_config_nonwk[SENSORLIST_INX_AMBIENT_IAQ + 1];
extern BSX_SENSOR_CONFIG
    *BSX_active_confref_nonwk[SENSORLIST_INX_AMBIENT_IAQ + 1];
extern BSX_SENSOR_CONFIG
    BSX_sensor_config_wk[SENSORLIST_INX_END -
                         SENSORLIST_INX_WAKEUP_SIGNI_PRESSURE];
extern BSX_SENSOR_CONFIG
    *BSX_active_confref_wk[SENSORLIST_INX_END -
                           SENSORLIST_INX_WAKEUP_SIGNI_PRESSURE];
extern uint32_t active_nonwksensor_cnt;
extern uint32_t active_wksensor_cnt;

extern void get_sensor_t(int32_t sensor_id, struct sensor_t **pp_sensor_t,
                         int32_t *p_list_inx);
