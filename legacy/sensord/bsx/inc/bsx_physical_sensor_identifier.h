...
#ifndef BSX_PHYSICAL_SENSOR_IDENTIFIER_H_
#define BSX_PHYSICAL_SENSOR_IDENTIFIER_H_

/*! @brief Provides the enumeration containing physical sensor identifier
 *
 * @{
 */
...
#endif /* BSX_PHYSICAL_SENSOR_IDENTIFIER_H_ */
