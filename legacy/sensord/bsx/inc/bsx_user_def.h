...
/*!
 * @brief Contains the user specific definitions to be included with
 * bsx_interface.h
 *
 * @note this shall typically be changeable and changed by a user, e.g. to
 * include sensors.h from the Android headers
 */
