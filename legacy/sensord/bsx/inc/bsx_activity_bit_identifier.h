...
typedef enum {
  ...
  BSX_ID_ACTIVITY_BIT_STILL_START =
      BSX_ID_ACTIVITY_START(BSX_ID_ACTIVITY_STILL),
  ...
  BSX_ID_ACTIVITY_BIT_INVEHICLE_START =
      BSX_ID_ACTIVITY_START(BSX_ID_ACTIVITY_INVEHICLE),
  BSX_ID_ACTIVITY_BIT_TILTING_START =
      BSX_ID_ACTIVITY_START(BSX_ID_ACTIVITY_TILTING),
  BSX_ID_ACTIVITY_BIT_VEHICLESTILL_START =
      BSX_ID_ACTIVITY_START(BSX_ID_ACTIVITY_VEHICLESTILL),
  ...
  BSX_ID_ACTIVITY_BIT_INVEHICLE_STOP =
      BSX_ID_ACTIVITY_STOP(BSX_ID_ACTIVITY_INVEHICLE),
  BSX_ID_ACTIVITY_BIT_TILTING_STOP =
      BSX_ID_ACTIVITY_STOP(BSX_ID_ACTIVITY_TILTING),
  BSX_ID_ACTIVITY_BIT_VEHICLESTILL_STOP =
      BSX_ID_ACTIVITY_STOP(BSX_ID_ACTIVITY_VEHICLESTILL)
