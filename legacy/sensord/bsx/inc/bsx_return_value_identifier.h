 ...
 * @{
 */
/** @brief Normal operation was successful without any warning or additional
 * information. */
#define BSX_OK (0)
...
/** @brief Difference of timestamps between subsequent doSteps calls is out of
 * range. */
...
/** @brief Difference of timestamps for multiples sensors at same doStep call is
 * out of range. */
...
/** @brief Invalid sample rate was given (sample rate for event based input, or
 * event enabled for sample rate based). */
...
/** @brief Invalid property identifier used in setting of configuration or
 * state. */
