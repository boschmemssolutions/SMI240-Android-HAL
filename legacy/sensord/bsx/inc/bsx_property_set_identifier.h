...
/** @brief phone related values, e.g. SIC matrix, conversion factors for sensor
...
/** @brief magnetometer related values, e.g. noise and offsets, for sensors such
 * as BMM*, YAS*, AK* */
...
#define BSX_PROPERTY_SET_ID_PREDEFINED_FILTERS_NDOF_ORIENTATION_CORRECTION_SPEED \
  (53)
...
#define BSX_PROPERTY_SET_ID_PREDEFINED_FILTERS_COMPASS_MAG_CALIB_ACC_AUTO_REC_MODE \
  (56)
...
#define BSX_PROPERTYSET_CALIBRATOR_ACCELEROMETER \
  BSX_PROPERTY_SET_ID_CALIBRATOR_ACCELEROMETER
#define BSX_PROPERTYSET_CALIBRATOR_MAGNETOMETER \
  BSX_PROPERTY_SET_ID_CALIBRATOR_MAGNETOMETER
#define BSX_PROPERTYSET_CALIBRATOR_GYROSCOPE \
  BSX_PROPERTY_SET_ID_CALIBRATOR_GYROSCOPE
/*!
 * @}
 */
