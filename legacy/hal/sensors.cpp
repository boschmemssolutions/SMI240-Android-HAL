...
sensors_poll_context_t::sensors_poll_context_t(
    const sensors_poll_context_t &other) {
  *this = other;
}

sensors_poll_context_t::~sensors_poll_context_t() { BoschSensor::destroy(); }
...
int sensors_poll_context_t::batch(int handle, int flags,
  ...
  return bosch_sensor->batch(handle, flags, sampling_period_ns,
