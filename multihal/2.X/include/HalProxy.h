 ...
 * framework.
 */
class HalProxy : public V2_0::implementation::IScopedWakelockRefCounter, public V2_0::implementation::ISubHalCallback {
public:
  ...
  explicit HalProxy(std::vector<ISensorsSubHalV2_0*>& subHalList, std::vector<ISensorsSubHalV2_1*>& subHalListV2_1);
  ~HalProxy();

  // Methods from ::android::hardware::sensors::V2_1::ISensors follow.
  Return<void> getSensorsList_2_1(ISensorsV2_1::getSensorsList_2_1_cb _hidl_cb);

  Return<Result> initialize_2_1(const ::android::hardware::MQDescriptorSync<V2_1::Event>& eventQueueDescriptor,
  ...
  Return<Result> initialize(const ::android::hardware::MQDescriptorSync<V1_0::Event>& eventQueueDescriptor,
                            const ::android::hardware::MQDescriptorSync<uint32_t>& wakeLockDescriptor,
  ...
  Return<void> registerDirectChannel(const SharedMemInfo& mem, ISensorsV2_0::registerDirectChannel_cb _hidl_cb);
  ...
  Return<void> onDynamicSensorsConnected(const hidl_vec<SensorInfo>& dynamicSensorsAdded, int32_t subHalIndex) override;
  ...
  const SensorInfo& getSensorInfo(int32_t sensorHandle) override { return mSensors[sensorHandle]; }

  bool areThreadsRunning() override { return mThreadsRun.load(); }

  // Below methods are from IScopedWakelockRefCounter interface
  bool incrementRefCountAndMaybeAcquireWakelock(size_t delta, int64_t* timeoutStart = nullptr) override;
...
class IHalProxy : public HalProxy, public ISensorsVersion {
  ...
  Return<Result> setOperationMode(OperationMode mode) override { return HalProxy::setOperationMode(mode); }
  ...
  Return<Result> injectSensorData(const V1_0::Event& event) override { return HalProxy::injectSensorData(event); }
...
class HalProxyV2_1 : public IHalProxy<V2_1::ISensors> {
  ...
  Return<Result> injectSensorData_2_1(const Event& event) override { return HalProxy::injectSensorData_2_1(event); }
};
