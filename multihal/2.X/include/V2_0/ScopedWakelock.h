...
const int64_t kWakelockTimeoutNs = static_cast<int64_t>(SensorTimeout::WAKE_LOCK_SECONDS) * INT64_C(1000000000);
...
public:
   ...
   */
  virtual bool incrementRefCountAndMaybeAcquireWakelock(size_t delta, int64_t* timeoutStart = nullptr) = 0;
  /**
   ...
   */
  virtual void decrementRefCountAndMaybeReleaseWakelock(size_t delta, int64_t timeoutStart = -1) = 0;
