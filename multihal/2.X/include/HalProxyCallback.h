...
public:
  ...
  virtual Return<void> onDynamicSensorsConnected(const hidl_vec<V2_1::SensorInfo>& dynamicSensorsAdded,
                                                 int32_t subHalIndex) = 0;

  virtual Return<void> onDynamicSensorsDisconnected(const hidl_vec<int32_t>& dynamicSensorHandlesRemoved,
                                                    int32_t subHalIndex) = 0;
   ...
   */
  virtual void postEventsToMessageQueue(const std::vector<V2_1::Event>& events, size_t numWakeupEvents,
...
public:
  HalProxyCallbackBase(ISubHalCallback* callback, V2_0::implementation::IScopedWakelockRefCounter* refCounter,
                       int32_t subHalIndex)
    : mCallback(callback), mRefCounter(refCounter), mSubHalIndex(subHalIndex) {}

  void postEvents(const std::vector<V2_1::Event>& events, V2_0::implementation::ScopedWakelock wakelock);
...
private:
  std::vector<V2_1::Event> processEvents(const std::vector<V2_1::Event>& events, size_t* numWakeupEvents) const;
};

class HalProxyCallbackV2_0 : public HalProxyCallbackBase, public V2_0::implementation::IHalProxyCallback {
public:
  HalProxyCallbackV2_0(ISubHalCallback* callback, V2_0::implementation::IScopedWakelockRefCounter* refCounter,
                       int32_t subHalIndex)
    : HalProxyCallbackBase(callback, refCounter, subHalIndex) {}

  Return<void> onDynamicSensorsConnected(const hidl_vec<V1_0::SensorInfo>& dynamicSensorsAdded) override {
    return mCallback->onDynamicSensorsConnected(V2_1::implementation::convertToNewSensorInfos(dynamicSensorsAdded),
                                                mSubHalIndex);
  }

  Return<void> onDynamicSensorsDisconnected(const hidl_vec<int32_t>& dynamicSensorHandlesRemoved) override {
    return mCallback->onDynamicSensorsDisconnected(dynamicSensorHandlesRemoved, mSubHalIndex);
  }

  void postEvents(const std::vector<V1_0::Event>& events, V2_0::implementation::ScopedWakelock wakelock) override {
    HalProxyCallbackBase::postEvents(V2_1::implementation::convertToNewEvents(events), std::move(wakelock));
  }
...
class HalProxyCallbackV2_1 : public HalProxyCallbackBase, public V2_1::implementation::IHalProxyCallback {
public:
  HalProxyCallbackV2_1(ISubHalCallback* callback, V2_0::implementation::IScopedWakelockRefCounter* refCounter,
                       int32_t subHalIndex)
    : HalProxyCallbackBase(callback, refCounter, subHalIndex) {}

  Return<void> onDynamicSensorsConnected_2_1(const hidl_vec<V2_1::SensorInfo>& dynamicSensorsAdded) override {
  ...
  void postEvents(const std::vector<V2_1::Event>& events, V2_0::implementation::ScopedWakelock wakelock) override {
