...
public:
  ...
  Return<V1_0::Result> initialize(const ::android::hardware::MQDescriptorSync<V1_0::Event>& /* eventQueueDescriptor */,
                                  const ::android::hardware::MQDescriptorSync<uint32_t>& /* wakeLockDescriptor */,
 ...
 */
__attribute__((visibility("default"))) extern "C" ::android::hardware::sensors::V2_1::implementation::ISensorsSubHal*
